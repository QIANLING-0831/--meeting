...
async function loadStatus(){
  try{
    ...
    const settings=s.realtimeSettings||{};$("pipelineMode").value=settings.pipelineMode||"dual";$("answerModel").value=settings.answerModel||"qwen-plus";$("realtimeModel").value=settings.model||"qwen-audio-3.0-realtime-plus";$("turnDetection").value=settings.turnDetection||"server_vad";$("workspaceId").value=settings.workspaceId||"";

...
async function loadStatus(){
  try{
    ...
    const snapshot=s.answerSnapshot||{};if(snapshot.question)$("questionBox").textContent=snapshot.question;renderQuestionMemory(snapshot.recentQuestions||[]);if(snapshot.text){answerBuffer=snapshot.text;$("answerOutput").textContent=answerBuffer}setRunning(Boolean(s.running));
